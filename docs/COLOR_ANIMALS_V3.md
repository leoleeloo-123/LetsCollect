...
- Draws select one of the three active models and one color palette independently with equal probability.
...
3. Confirm repeated draws can produce Color Dog, Color Bird, and Color Teddy with random palettes and add them to the collection.
4. Confirm all three models preserve their protected facial details in the live viewer and cached thumbnails.
