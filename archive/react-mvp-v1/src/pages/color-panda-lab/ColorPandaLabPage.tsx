...
import { ColorPandaLabViewer, type PandaHatVariant } from "../../three/ColorPandaLab/ColorPandaLabViewer";

const variantPool: PandaHatVariant[] = [
...
export function ColorPandaLabPage() {
    ...
    <main className="color-animal-page color-animal-page--single color-panda-page">
      ...
      <section className="color-animal-intro">
        <div>
          ...
          <p>熊猫身体、黑白花纹、眼睛、鼻嘴和腮红始终保留原色。随机按钮只改变头顶帽子的织物颜色。</p>
        </div>
