...
export const mockToys = [
  generateCollectible({ id: "toy_001", publicCode: "LC-OTTER001", seed: 73, modelId: "color-otter", paletteId: "cream-rose", createdAt: "2026-07-01T00:00:00.000Z" }),
  generateCollectible({ id: "toy_002", publicCode: "LC-OTTER002", seed: 26, modelId: "color-otter", paletteId: "candy-mint", createdAt: "2026-07-02T00:00:00.000Z" }),
  generateCollectible({ id: "toy_003", publicCode: "LC-OTTER003", seed: 64, modelId: "color-otter", paletteId: "apricot", createdAt: "2026-07-03T00:00:00.000Z" }),
  generateCollectible({ id: "toy_004", publicCode: "LC-OTTER004", seed: 8, modelId: "color-otter", paletteId: "berry", createdAt: "2026-07-04T00:00:00.000Z" }),
  generateCollectible({ id: "toy_005", publicCode: "LC-OTTER005", seed: 7, modelId: "color-otter", paletteId: "sky", createdAt: "2026-07-05T00:00:00.000Z" }),
...
export const starterCollectionToys = [mockToys[0], mockToys[6], mockToys[8], mockToys[9], mockToys[10], mockToys[11]].map((toy) => ({
  ...toy,
  id: `starter_${toy.modelId}`,
  publicCode: `LC-START-${toy.modelId.toUpperCase()}`
}));
